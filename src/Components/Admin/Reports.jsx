...
console.log(count18)
console.log(count25)
// let range1=data.filter((e)=>{
//    convert=Number(e.Age);
//    if(convert>13 ||convert<18){
//     count13++
//   }
//   // return count13;
// })
// console.log(range1,"surya data")
...
const rows = [
  ...
  createData('Average group size of people attending the event',0,0,0, 4),
